...
tags:
  - "DDD"
  - "domaindrivendesign"
description: "애그리거트, 애그리거트 루트, 애그리거트 리포지터리, ID를 이용한 애그리거트 참조, 애그리거트간 집합 연관, 팩토리사용하기에 대한 설명입니다."
---
...
![](/media/chapter3/3.2.jpeg) ![](/media/chapter3/3.3.jpeg) 
